...
public:
    ...
    uint64_t GetLastInsertId() const { return LastInsertId; }
    size_t   GetLastResultRows() const { return LastResultRows; }
    size_t   GetLastAffectedRows() const { return LastAffectedRows; }
